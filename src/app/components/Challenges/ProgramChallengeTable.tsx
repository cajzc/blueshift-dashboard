  ...
  return (
    <div>
      <ChallengeCompleted
        ...
        challenge={challenge}
      />
      <div className="relative flex flex-col gap-y-4 w-full overflow-hidden px-1.5 pt-1.5 pb-12 border rounded-2xl border-border bg-card-solid">
        ...
        <div
          className={classNames(
            "gap-y-6 sm:gap-y-0 flex sm:flex-row flex-col items-center justify-between px-4 sm:px-6 py-4 sm:py-5 rounded-[10px] bg-card-solid-foreground"
          )}
        >
        ...
        <div className="flex flex-col gap-y-2 px-2">
          {requirements.map((requirement) => (
            <motion.button
              ...
              type="button"
              className={classNames(
                "flex flex-col gap-y-4 group sm:px-4 enabled:hover:cursor-pointer py-3 rounded-xl transition duration-200 enabled:hover:bg-card-solid-foreground/50",
