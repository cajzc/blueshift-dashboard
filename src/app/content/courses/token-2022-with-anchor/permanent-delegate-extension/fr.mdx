...
Cela signifie que nous pouvons utiliser les instructions `transferChecked()`, `burnChecked()`, etc... et passer l'autorité `PermanentDelegate` dans le champs `authority`.